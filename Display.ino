...
Zonen mainscreen[ARRAYLENGTH] = {
    ...
    {62, 41, 46, 2, 1, 0, 8888, 0, true}}; // Zone 10    val üNN
 ...
 * https://marlinfw.org/tools/u8glib/converter.html
 *
 * This bitmap from the file 'Hoehenmeter.bmp'
 */
...
void showZones(Zonen zzones[], int arrayLength)
{
    ...
    display.drawBitmap(SCREEN_WIDTH - BIKE_BMPWIDTH, 0, bitmap_bike[bikeAnimationBitmap], BIKE_BMPWIDTH, BIKE_BMPHEIGHT, 1);
    display.drawBitmap(SCREEN_WIDTH - HOEHENMETER_BMPWIDTH, 41, bitmap_hoehenmeter, HOEHENMETER_BMPWIDTH, HOEHENMETER_BMPHEIGHT, 1);
